...
<head>
	...
	<title>Max Vehicle Rental | New Bookings   </title>
	...
	<!-- logo -->
	<link rel="shortcut icon" href="img/maxlogo.jpg">
...
<div id="print">
	...
	<h3 style="text-align:center; color:red">#<?php echo htmlentities($result->BookingNumber);?> Booking Details </h3>
		...
		<tr>
			<th colspan="4" style="text-align:center;color:blue">User Details</th></tr>
				<tr>
				 	<th>Booking No.</th>
				...
				<tr>
					<th colspan="4" style="text-align:center;color:blue">Booking Details</th></tr>
